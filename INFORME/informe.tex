...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|}
        \hline
        Año & UF (Pesos) & $\Delta$ \% UF & Bencina 95 (USD) & $\Delta$ \% Bencina & Metro (CLP) & $\Delta$ \% Metro\\
        \hline
        2012 & 22.296,19 & - & 1.56  & - & 610 & - \\
        2017 & 26.348,83 & 18.2\% & 1.15 & -26.28 & 660 & 8.19 \\
        2023 & 35.122,26 & 57.6\% & 1.64 & 5.13 & 730 & 19.67 \\
        \hline
    \end{tabular}
    \vspace{0.2cm}
