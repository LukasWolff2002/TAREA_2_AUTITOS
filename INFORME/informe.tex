...
%----------------------------------------------------------------------------------------
%Aquí van unos tips básicos de LaTeX
\newpage
\section{LaTeX Tips}
...
\begin{figure}[H] %Es importante poner H mayúscula aquí, de este modo la imagen queda fijada en esta posición
    \centering
...
\begin{figure}[H] %Enfatizo la H mayúscula para que las imágenes queden fijas en esta posición
    \centering
