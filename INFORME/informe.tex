...
personas total, dividido por el promedio de personas por hogar en cada año. Los datos obtenidos para los cálculos se presentan en la subsección 
\ref{sec:Datos_EP} de Anexos.
