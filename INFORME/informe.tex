...
\begin{table}[H]
    ...
    & \multicolumn{1}{|c|}{\(\sigma\)} & \multicolumn{1}{|c|}{0.010} & \multicolumn{1}{|c|}{0.053} \\ \hline
    $X_e$ & \multicolumn{1}{|c|}{\(\mu\)} & \multicolumn{1}{|c|}{0.544} & \multicolumn{1}{|c|}{0.710} \\ \cline{2-4}
    & \multicolumn{1}{|c|}{\(\sigma\)} & \multicolumn{1}{|c|}{0.045} & \multicolumn{1}{|c|}{0.054} \\ \hline
    $X_t$ & \multicolumn{1}{|c|}{\(\mu\)} & \multicolumn{1}{|c|}{1.539} & \multicolumn{1}{|c|}{1.910} \\ \cline{2-4}
    & \multicolumn{1}{|c|}{\(\sigma\)} & \multicolumn{1}{|c|}{0.074} & \multicolumn{1}{|c|}{0.117} \\ \hline
    $X_j$ & \multicolumn{1}{|c|}{\(\mu\)} & \multicolumn{1}{|c|}{0.479} & \multicolumn{1}{|c|}{0.307} \\ \cline{2-4}
    & \multicolumn{1}{|c|}{\(\sigma\)} & \multicolumn{1}{|c|}{0.064} & \multicolumn{1}{|c|}{0.011} \\ \hline
    \end{tabular}
