...
\begin{flushleft}
    Hablar aqui del resumen del informe actual, no puede exceer las 250 palabras. Poner palabras clave, ademas de selccionar 3 palabras clave por los autores. HAY 174 PALABRAS\\
...
\\ \\
Finalmente, haciendo un analisis estadistico de los datos, se concluye que los datos se pueden considerar representativos y precisos, dada la procedencia de estos y su correlacion muestral con poblacional según el estadístico T Student.
